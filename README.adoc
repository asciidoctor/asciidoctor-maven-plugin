...
image:http://img.shields.io/coveralls/asciidoctor/asciidoctor-maven-plugin/master.svg["Coverage Status", link="https://coveralls.io/r/asciidoctor/asciidoctor-maven-plugin"]
