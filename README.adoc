...
[NOTE]
====
Backends that embed resources, need to locate them at the time of conversion.
For example, in the case of pdf and images, all reosurces should be aggregated under a single directory, and `imagesdir` attribute should be set to point to it.
====
+
[source, xml]
----
