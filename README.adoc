...
title:: An override for the title of the document, empty by default
templateDir:: defaults to `null`
attributes:: a `Map<String,String>` of attributes to pass to Asciidoctor, defaults to `null`

In addition to the attributes map, many of the attributes now have their own configuration line:

copyCss:: defaults to `false`
dataUri:: defaults to `false`
docTime:: defaults to `null`
experimental:: defaults to `false`
admonitionWithFontAwesome:: defaults to `true`
icons:: defaults to an empty string
iconsDir:: defaults to an empty string
linkAttrs:: defaults to `false`
linkCss:: defaults to `false`
localDate:: defaults to `null`
localTime:: defaults to `null`
noStylesheetName:: defaults to `false`
originalAdmonitionIcons:: defaults to `false`
stylesDir:: defaults to an empty string
stylesheetName:: defaults to an empty string
toc:: defaults to `false`;
extensions:: defaults to an empty `List<String>`
