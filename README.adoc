...
:uri-docs: https://asciidoctor.github.io/asciidoctor-maven-plugin/maven-plugin/{docs-version}
...
This minimal guide will allow you to convert your AsciiDoc documents to HTML with the asciidoctor-maven-plugin.
